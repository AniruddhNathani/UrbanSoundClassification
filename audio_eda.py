...
df = pd.read_csv(r'C:\Users\hp\Desktop\Audio classification\InstrumentClassifiermaster\instruments.csv')
df.set_index('fname', inplace=True)

for f in df.index:
    rate, signal = wavfile.read(r'C:\Users\hp\Desktop\Audio classification\InstrumentClassifiermaster\wavfiles/'+f)
...
for c in classes:
    ...
    rate, signal = wavfile.read(r'C:\Users\hp\Desktop\Audio classification\InstrumentClassifiermaster\wavfiles/'+wav_file)
